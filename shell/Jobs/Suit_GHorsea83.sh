...
#SBATCH -t 24:00:00
#SBATCH --gres=gpu:1
#SBATCH --job-name=a83GHorse
#SBATCH --output=a83Suit_GHorse.%j.out
...
python3 -m Pytorch.Grid.Suits.Suit_GHorsea83 &>/usr/users/truhkop/Thesis/Pytorch/Experiment/Suit_GHorsea83.out
