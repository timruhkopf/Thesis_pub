...
#SBATCH -t 48:00:00
#SBATCH --gres=gpu:1
#SBATCH --job-name=a83Suit_Shrinkage
#SBATCH --output=a83Suit_Shrinkage.%j.out
...
python3 -m Pytorch.Grid.Suits.Suit_Shrinkagea83 &>/usr/users/truhkop/Thesis/Pytorch/Experiment/Suit_Shrinkagea83.out
