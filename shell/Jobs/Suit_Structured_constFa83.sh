...
#SBATCH -t 48:00:00
#SBATCH --gres=gpu:1
#SBATCH --job-name=a83Suit_Structured
#SBATCH --output=a83Suit_Structured.%j.out
...
python3 -m Pytorch.Grid.Suits.Suit_Structured_const_Fa83 &>/usr/users/truhkop/Thesis/Pytorch/Experiment/Suit_StructuredFa83.out
