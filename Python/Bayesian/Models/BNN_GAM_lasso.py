...
from Python.Bayesian.Models.GAM_RW import GAM_RW
from Python.Bayesian.layers.HiddenGroupLasso import HiddenGroupLasso
from Python.Effects.bspline import get_design
...
from Python.Bayesian.plot1d import triangulate_remove_artifacts
...
class BNN_GAM_lasso:
    ...
    def forward(self, X, Z, bnn_param, gam_param):
        # bnn.forward leverages each layers dense method, which in this thesis
...
if __name__ == '__main__':
    ...
    from Python.Data.K_Surface import K_surface
    from Python.Bayesian.Samplers.AdaptiveHMC import AdaptiveHMC
